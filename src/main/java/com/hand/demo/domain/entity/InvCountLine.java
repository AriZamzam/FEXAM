...
public class InvCountLine extends AuditDomain {
    private static final long serialVersionUID = 754789803042317720L;
    ...
    @Id
    @GeneratedValue
    @NotNull(groups = ValidRequestClass.class, message = "Should not empty")
    ...
    @NotNull(groups = ValidLineClass.class, message = "Should not empty")
    ...
    public interface ValidLineClass{}
    public interface ValidRequestClass{};
}
